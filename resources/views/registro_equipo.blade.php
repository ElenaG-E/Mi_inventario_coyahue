                        ...
                        <div class="mb-3" id="bloqueTipo" style="display:none;">
                            ...
                            <select name="tipo_equipo_id" id="tipo_equipo_id" class="form-select">
                                ...
                                @foreach ($tipos as $tipo)
                                    {{-- Añadimos data-tipo si está disponible (más robusto) --}}
                        ...
                        <div id="camposEquipo" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="precio" id="precio_equipo" class="form-control" value="{{ old('precio') }}">
                        ...
                        <div id="especificacionesTecnicas" style="display:none;">
                            ...
                            <div id="bloqueMonitor" class="bloque-especificaciones" style="display:none;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Resolución pantalla</label>
                                        <input type="text" name="resolucion_pantalla_monitor" class="form-control" value="{{ old('resolucion_pantalla_monitor') }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Tipo de panel</label>
                                        <input type="text" name="tipo_panel_monitor" class="form-control" value="{{ old('tipo_panel_monitor') }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Frecuencia (Hz)</label>
                                        <input type="number" name="frecuencia_hz_monitor" class="form-control" min="0" value="{{ old('frecuencia_hz_monitor') }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="camposInsumo" style="display:none;">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="nombreInsumo" name="nombre_insumo" class="form-control" placeholder="Escribe o selecciona un insumo" value="{{ old('nombre_insumo') }}">
...
(function () {
    ...
    const precioInput = $('#precio_equipo') || document.querySelector('input[name="precio"]');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Autocomplete jQuery UI (si está disponible)
        try {
            const insumos = @json($insumosExistentes->pluck('nombre'));
            if (window.jQuery && $('#nombreInsumo').length) {
                $('#nombreInsumo').autocomplete({ source: insumos, minLength: 1 });
            }
        } catch (err) {
            // Si jQuery/autocomplete no existe, no hay problema.
            console.warn('Autocomplete no inicializado:', err);
        }
